...
# inputs
type_in = '~boston' 	# data type to use - drunk_bow_tie x_cubed_gap ~boston
loss_type = 'qd_soft' 		# loss type to train on - qd_soft mve mse (mse=simple point prediction)
n_samples = 100		# if generating data, how many points to generate，原来是100
...
for run in range(0, n_runs):
	...
	print('\n--- view data ---')
	Gen.ViewData(n_rows=5, hist=False)
